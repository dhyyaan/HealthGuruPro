...
import com.think360.pro.healthguru.doctors.databinding.NewAppointmentFragmentBinding
...
class NewAppointmentFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val   newAptFragmentBinding   = DataBindingUtil.inflate<NewAppointmentFragmentBinding>(inflater, R.layout.new_appointment_fragment, container, false)
        ...
        mPackagesList.add(4, PatientsItem("GurPreet Singh","Corporate","M","02-03",R.drawable.user_2))

        val adapter = PatientsBindingAdapter(actionCallback,mPackagesList )

        newAptFragmentBinding.rvRearchResult.adapter = adapter
        adapter.notifyDataSetChanged()

        return newAptFragmentBinding.root
    }
}
