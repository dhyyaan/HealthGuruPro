package com.think360.pro.healthguru.registration.customview;
...
public class OtpView extends LinearLayoutCompat {
    private AppCompatEditText mOtpOneField, mOtpTwoField, mOtpThreeField, mOtpFourField, mOtpFiveField, mOtpSixField,
